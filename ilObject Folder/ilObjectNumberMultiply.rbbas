#tag Class
Protected Class ilObjectNumberMultiply
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Multiply", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Multiply", "[self " + GetCodeName + "];")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscMultiply"
		  me.BGColor =  frmProject.kcolNumbers
		  me.DisplayName = "Multiply"
		  me.DisplayCategory = "Numbers"
		  me.Title = "Multiply"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Multiply"
