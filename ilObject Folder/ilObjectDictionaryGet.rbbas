#tag Class
Protected Class ilObjectDictionaryGet
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalAndroidName + " = " + _
		  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalAndroidName + ".get(" + _
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalFlexName + " = " + _
		  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + "[" + _
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalAndroidName + " = [" + _
		  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalAndroidName + " objectForKey:" + _
		  modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalAndroidName + "];" + EndOfLine
		  ...
		  setCodeToCallThisObjectForName("Get", "[self " + GetCodeName + "];")
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " " + modVariables.VariableObjectFromName(MathVariable2).ISCPythonName + " = " + _
		  modVariables.VariableObjectFromName(OriginVariable).ISCPythonName + "[" + _
		  modVariables.VariableObjectFromName(MathVariable1).ISCPythonName + "]" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscDictGet"
		  me.BGColor =  frmProject.kcolDictionary
		  me.DisplayName = "Get From Dictionary"
		  me.DisplayCategory = "Dictionaries"
		  me.Title = "Get From Dictionary"
		  me.Width = 90
