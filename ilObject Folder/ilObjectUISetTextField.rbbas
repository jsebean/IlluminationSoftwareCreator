#tag Class
Protected Class ilObjectUISetTextField
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string)
		  ...
		  s = s + "document.getElementById(""" + tempILUI.ISCClassLocalFlexName + """).value = " + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalFlexName + ";" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + " " + tempILUI.ISCPythonName + ".get_buffer().set_text(" + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + ")" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSetTextField"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Set TextField"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Set TextField"
		  me.Width = 90
