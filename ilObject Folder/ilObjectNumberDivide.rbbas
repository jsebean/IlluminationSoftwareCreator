#tag Class
Protected Class ilObjectNumberDivide
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Divide", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Divide", "[self " + GetCodeName + "];")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscDivide"
		  me.BGColor =  frmProject.kcolNumbers
		  me.DisplayName = "Divide"
		  me.DisplayCategory = "Numbers"
		  me.Title = "Divide"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Divide"
