#tag Class
Protected Class ilObjectUIGetTextBox
Inherits ilObjectBase
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + " " + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + " = " + tempILUI.ISCPythonName + ".get_text()" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscGetTextBox"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Get TextBox"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Get TextBox"
		  me.Width = 90
