#tag Class
Protected Class ilObjectNumberRemainder
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Remainder", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Remainder", "[self " + GetCodeName + "];")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscRemainder"
		  me.BGColor =  frmProject.kcolNumbers
		  me.DisplayName = "Remainder"
		  me.DisplayCategory = "Numbers"
		  me.Title = "Remainder"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Remainder"
