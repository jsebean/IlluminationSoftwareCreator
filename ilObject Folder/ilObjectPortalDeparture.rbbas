#tag Class
Protected Class ilObjectPortalDeparture
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Depart", "[self " + GetCodeName + "];")
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string)
		  ...
		  s = s + GetDestinationCall(OriginVariable) + EndOfLine
		  //modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName)
		  ...
		  'HelperGenerateJavascriptWebCodePhase2(
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscPortalDeparture"
		  me.BGColor =  frmProject.kcolLogic
		  me.DisplayName = "Departure Portal"
		  me.DisplayCategory = "Logic"
		  me.Title = "Departure Portal"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Depart"
	...
	#tag Method, Flags = &h0
		Function GetDestinationCall(theOriginVariable as string) As string
		  dim i as integer
		  ...
		  for i = 0 to frmProject.chartProject.frames.Ubound
		    ...
		    if frmProject.chartProject.frames(i).tag isa ilObjectPortalDestination then
		      ...
		      if ilObjectPortalDestination(frmProject.chartProject.frames(i).tag).OriginVariable = theOriginVariable then
		        
		        Return frmProject.chartProject.frames(i).contents(0).codetocallthisobject
