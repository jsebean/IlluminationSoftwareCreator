#tag Class
Protected Class ilObjectNumberSubtract
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Subtract", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Subtract", "[self " + GetCodeName + "];")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSubtract"
		  me.BGColor =  frmProject.kcolNumbers
		  me.DisplayName = "Subtract"
		  me.DisplayCategory = "Numbers"
		  me.Title = "Subtract"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Subtract"
