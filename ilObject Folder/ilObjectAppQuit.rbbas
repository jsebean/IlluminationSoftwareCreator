#tag Class
Protected Class ilObjectAppQuit
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Quit", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Quit", "[self " + GetCodeName + "];")
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " thisiscApp1.destroy(None,None)" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscAppQuit"
		  me.BGColor = rgb(0,38,255)
		  me.DisplayName = "Quit Application"
		  me.DisplayCategory = "Application"
		  me.Title = "Quit Application"
		  me.Width = 110
		  
		  me.ObjectItems.Append "Quit"
