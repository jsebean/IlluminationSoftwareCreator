#tag Class
Protected Class ilObjectFileOpenTextFileDialog
Inherits ilObjectBase
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " " + "dialog = gtk.FileChooserDialog(""Open.."", None, gtk.FILE_CHOOSER_ACTION_OPEN,  (gtk.STOCK_CANCEL, gtk.RESPONSE_CANCEL" + _
		  ",gtk.STOCK_OPEN, gtk.RESPONSE_OK))" + EndOfLine
		  ...
		  s = s + " " + "filter.add_mime_type(""text/txt"")" + EndOfLine
		  s = s + " " + "filter.add_mime_type(""image/jpeg"")" + EndOfLine
		  s = s + " " + "filter.add_pattern(""*.txt"")" + EndOfLine
		  s = s + " " + "filter.add_pattern(""*.text"")" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscOpenTextFileDialog"
		  me.BGColor =  frmProject.kcolFiles
		  me.DisplayName = "Open Text File Dialog"
		  me.DisplayCategory = "Files"
		  me.Title = "Open Text File Dialog"
		  me.Width = 150
