#tag Class
Protected Class ilObjectUISetColorButton
Inherits ilObjectBase
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + " " + tempILUI.ISCPythonName + ".set_color(" + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + ")" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSetColorButton"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Set ColorButton"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Set ColorButton"
		  me.Width = 90
