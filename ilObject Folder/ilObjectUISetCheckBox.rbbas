#tag Class
Protected Class ilObjectUISetCheckBox
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + "if (" + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + " == 1)" + EndOfLine
		    s = s + "{" + EndOfLine
		    s = s + tempILUI.ISCClassLocalAndroidName + ".setChecked(true);" + EndOfLine
		    s = s + "}" + EndOfLine
		    s = s + "else" + EndOfLine
		    s = s + "{" + EndOfLine
		    s = s + tempILUI.ISCClassLocalAndroidName + ".setChecked(false);" + EndOfLine
		    s = s + "}" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSetCheckBox"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Set CheckBox"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Set CheckBox"
		  me.Width = 90
