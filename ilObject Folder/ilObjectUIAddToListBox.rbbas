#tag Class
Protected Class ilObjectUIAddToListBox
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + tempILUI.ISCClassLocalAndroidName + "listAdapter.add(" + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + ");" + EndOfLine
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string)
		  ...
		  s = s + "var htmlSelect=document.getElementById('" + tempILUI.ISCClassLocalPythonName + "');" + EndOfLine
		  
		  s = s + "var selectBoxOption = document.createElement(""Option"");" + EndOfLine
		  
		  s = s + "selectBoxOption.value = " + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalPythonName + ";" + EndOfLine
		  s = s + "selectBoxOption.text = " + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalPythonName + ";" + EndOfLine
		  
		  s = s + "htmlSelect.add(selectBoxOption, null);" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscAddToListBox"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Add To ListBox"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Add To ListBox"
		  me.Width = 90
