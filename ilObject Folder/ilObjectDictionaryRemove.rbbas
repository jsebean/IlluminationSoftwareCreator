#tag Class
Protected Class ilObjectDictionaryRemove
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalAndroidName + ".remove(""" + _
		  ...
		  setCodeToCallThisObjectForName("Remove", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  s = s + "delete " + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + "[" + _
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + "[" + modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalAndroidName + " removeObjectForKey:" + _
		  modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalAndroidName + "];" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " del " + modVariables.VariableObjectFromName(OriginVariable).ISCPythonName + "[" + _
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscDictRemove"
		  me.BGColor =  frmProject.kcolDictionary
		  me.DisplayName = "Remove From Dictionary"
		  me.DisplayCategory = "Dictionaries"
		  me.Title = "Remove From Dictionary"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Remove"
