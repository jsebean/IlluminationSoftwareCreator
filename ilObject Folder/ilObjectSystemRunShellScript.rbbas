#tag Class
Protected Class ilObjectSystemRunShellScript
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Run", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  setCodeToCallThisObjectForName("Run", "[self " + GetCodeName + "];")
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " os.system(" + modVariables.VariableObjectFromName(OriginVariable).ISCPythonName + ")" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscRunShellScript"
		  me.BGColor =  frmProject.kcolSystem
		  me.DisplayName = "Run Shell Script"
		  me.DisplayCategory = "System"
		  me.Title = "Run Shell Scrypt"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Run"
