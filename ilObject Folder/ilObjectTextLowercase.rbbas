#tag Class
Protected Class ilObjectTextLowercase
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + ".toLowerCase()" + EndOfLine
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalFlexName + ".toLowerCase()" + EndOfLine
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCiOSName + " = [" + modVariables.VariableObjectFromName(MessageFromVariable).ISCiOSName + " lowercaseString];" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + ".lower()" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscLowercase"
		  me.BGColor =  frmProject.kcolText
		  me.DisplayName = "Lowercase"
