#tag Class
Protected Class ilObjectNumberSetNumber
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  if UseVariableForMessage = true then
		    s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + ";" + EndOfLine
		  else
		    s = s + CustomMessage + ";" + EndOfLine
		  end if
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  if UseVariableForMessage = true then
		    s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + EndOfLine
		  else
		    s = s + CustomMessage + EndOfLine
		  end if
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscSetNumber"
		  me.BGColor =  frmProject.kcolNumbers
		  me.DisplayName = "Set Number"
