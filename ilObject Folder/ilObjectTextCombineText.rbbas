#tag Class
Protected Class ilObjectTextCombineText
Inherits ilObjectBase
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCiOSName + " = [" + modVariables.VariableObjectFromName(MathVariable1).ISCiOSName + _
		  " stringByAppendingString:" + modVariables.VariableObjectFromName(MathVariable2).ISCiOSName + "];" + EndOfLine
		  
		  s = s + "//" + GetCodeName + "Done" + EndOfLine
		  s = s + "" + EndOfLine
		  s = s + "}" + EndOfLine + EndOfLine
		  
		  setCodeToCallThisObjectForName("Combine", "[self " + GetCodeName + "];")
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscCombineText"
		  me.BGColor =  frmProject.kcolText
		  me.DisplayName = "CombineText"
		  me.DisplayCategory = "Text"
		  me.Title = "CombineText"
		  me.Width = 90
		  
		  me.ObjectItems.Append "Combine"
