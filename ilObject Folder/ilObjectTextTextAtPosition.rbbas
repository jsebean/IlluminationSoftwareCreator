#tag Class
Protected Class ilObjectTextTextAtPosition
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalAndroidName + ".substring(" + _
		  modVariables.VariableObjectFromName(MathVariable2).ISCClassLocalAndroidName + "," + _
		  modVariables.VariableObjectFromName(MathVariable3).ISCClassLocalAndroidName + ");" + EndOfLine
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(MathVariable1).ISCClassLocalFlexName + ".substring(" + _
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(MathVariable1).ISCiOSName + " substringWithRange: NSMakeRange (" + _
		  modVariables.VariableObjectFromName(MathVariable2).ISCiOSName + ", " + _
		  modVariables.VariableObjectFromName(MathVariable3).ISCiOSName + ")];" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(MathVariable3).ISCPythonName + "]" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscTextAtPosition"
		  me.BGColor =  frmProject.kcolText
		  me.DisplayName = "TextAtPosition"
		  me.DisplayCategory = "Text"
		  me.Title = "TextAtPosition"
		  me.Width = 90
