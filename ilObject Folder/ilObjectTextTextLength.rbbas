#tag Class
Protected Class ilObjectTextTextLength
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalAndroidName + ".length;" + EndOfLine
		  
		  s = s + "//" + GetCodeName + "Done" + EndOfLine
		  
		  s = s + "}" + EndOfLine + EndOfLine
		  
		  setCodeToCallThisObjectForName("Combine", GetCodeName + "();")
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  modVariables.VariableObjectFromName(OriginVariable).ISCClassLocalFlexName + ".length;" + EndOfLine
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MathVariable1).ISCiOSName + " = [" + modVariables.VariableObjectFromName(OriginVariable).ISCiOSName + _
		  " length];" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + " " + modVariables.VariableObjectFromName(MathVariable1).ISCPythonName + " = len(" + _
		  modVariables.VariableObjectFromName(OriginVariable).ISCPythonName + ")" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscTextLength"
		  me.BGColor =  frmProject.kcolText
		  me.DisplayName = "Text Length"
		  me.DisplayCategory = "Text"
		  me.Title = "Text Length"
		  me.Width = 90
