#tag Class
Protected Class ilObjectTextUppercase
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + ".toUpperCase()" + EndOfLine
	...
	#tag Event
		Sub GenerateFlexWebCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalFlexName + ".toUpperCase()" + EndOfLine
	...
	#tag Event
		Sub GenerateiOSCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(OriginVariable).ISCiOSName + " = [" + modVariables.VariableObjectFromName(MessageFromVariable).ISCiOSName + " uppercaseString];" + EndOfLine
	...
	#tag Event
		Sub GeneratePythonDesktopCode(theOrigin as string)
		  ...
		  s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCPythonName + ".upper()" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscUppercase"
		  me.BGColor =  frmProject.kcolText
		  me.DisplayName = "Uppercase"
