#tag Class
Protected Class ilObjectUIGetListBoxSelection
Inherits ilObjectBase
	#tag Event
		Sub GenerateAndroidCode(theOrigin as string)
		  ...
		  if tempILUI <> nil then
		    ...
		    s = s + modVariables.VariableObjectFromName(MessageFromVariable).ISCClassLocalAndroidName + " = " + _
		    tempILUI.ISCClassLocalAndroidName + "SelectedItem;" + EndOfLine
	...
	#tag Event
		Sub GenerateJavaScriptWebCode(theOrigin as string)
		  ...
		  s = s + "var txtItem = htmlSelect.options[htmlSelect.selectedIndex].text;" + EndOfLine
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  me.CodeNameBase = "iscGetListBoxSelection"
		  me.BGColor =  frmProject.kcolUserInterface
		  me.DisplayName = "Get ListBox Selection"
		  me.DisplayCategory = "User Interface"
		  me.Title = "Get ListBox Selection"
		  me.Width = 90
